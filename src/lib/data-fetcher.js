...
export async function fetchHomeData() {
    return fetchDocCached("websites/spinreactin/pages/home");
}

export async function fetchContactData() {
    return fetchDocCached("websites/spinreactin/pages/contact");
}

export async function fetchServicesData() {
    return fetchDocCached("websites/spinreactin/pages/services");
}

export async function fetchDistrictData(district) {
    if (!district) return null;
    return fetchDocCached(`websites/spinreactin/districts/${district}`);
}
...
export function subscribeToCatalog(onUpdate) {
    ...
    try {
        const legacyUnsub = onSnapshot(
            doc(db, "websites", "spinreactin", "pages", "products"),
            (docSnap) => {
                if (docSnap.exists()) {
